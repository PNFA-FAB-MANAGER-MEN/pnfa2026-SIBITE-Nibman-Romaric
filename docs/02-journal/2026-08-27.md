...
![Objet en cours d'impression](../medias/impression.png)

![Objet imprimé](../medias/matimp.png)
...
![Carte de visite conçue avec xTool](../medias/cartext.png)

![Carte de visite conçue](../medias/Carte.jpeg)

* Découpe et gravure sur du bois avec la machine de découpe laser **xTool P3**.

![Découpe laser avec xTool P3](../medias/Xtooldecoupe.png)
...
![Code réalisé avec mBlock](../medias/mblock.png)
